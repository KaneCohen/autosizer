...
const _defaults = {
  ...
  styles: [
    ...
    'lineHeight', 'fontFamily', 'fontSize', 'fontWeight', 'fontStyle',
    'letterSpacing', 'textTransform', 'wordSpacing', 'textIndent', 'boxSizing'
  ],
  attributes: ['rows']
};
...
class Autosizer extends EventEmitter {
  ...
  update() {
    ...
    const rows = Math.ceil((clone.scrollHeight - (
        parseInt(clone.style.paddingTop || 0, 10) +
        parseInt(clone.style.paddingBottom || 0, 10)
